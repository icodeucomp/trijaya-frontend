...
export const ProjectSector = ({ slug }: { slug: string }) => {
  ...
  const { response: resProjects, loading } = useGetApi<ResponseBusinessesSectorTypes>({ path: `/projects?business=${slug}`, limit: "1000000" });
