  ...
  return (
    <div className="grid w-full grid-cols-1 mx-auto lg:grid-cols-2 max-w-screen-2xl">
      <Background
        ...
        className="flex-col w-full h-full gap-40 py-20 lg:gap-0 lg:justify-between sm:py-28 md:py-32"
      ...
      >
        ...
        <Motion
          ...
          duration={0.3}
          delay={0.6}
          className="flex items-center gap-4 px-2 text-justify sm:px-6 md:px-12 lg:px-14 text-light"
        >
      ...
      <div className="w-full px-4 py-8 space-y-4 sm:p-8 sm:space-y-8 bg-light-gray">
        {businessLists.map((item, index) => (
          <Motion
            ...
            delay={index * 0.1}
            key={index}
            className="flex items-center gap-4 px-4 py-4 rounded-lg sm:px-8 bg-primary"
          >
