...
export const EditDocument = ({ stylesOptions }: { stylesOptions: StyleTypes }) => {
        ...
        {modal && (
          <Modal isVisible={modal} onClose={toggleModal} className="max-w-xl">
            <form className="space-y-4 md:min-w-xl" encType="multipart/form-data">
              <h1 className="text-lg font-semibold text-center sm:text-start text-primary">Edit Document</h1>
