  ...
  return (
    <Container id="vision-mission" className="pt-4 pb-20 space-y-10 md:pt-10 md:space-y-16 text-primary">
      ...
      <div className="grid grid-cols-1 gap-4 text-justify md:grid-cols-5 place-items-center md:gap-8">
        <div className="w-full overflow-hidden rounded-lg md:col-span-2">
          <Img src="/images/profile-vision.webp" alt="vision image" className="w-full max-w-lg mx-auto h-72 md:h-60 lg:h-72" cover />
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 text-justify md:grid-cols-5 place-items-center md:gap-8">
        ...
        <div className="order-1 w-full overflow-hidden rounded-lg md:col-span-2 md:order-2">
          <Img src="/images/profile-mission.webp" alt="vision image" className="w-full max-w-lg mx-auto h-72 md:h-60 lg:h-72" cover />
        </div>
      </div>
    </Container>
  );
